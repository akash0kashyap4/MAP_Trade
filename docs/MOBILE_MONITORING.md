# MAP Trade — LAN Dashboard Monitoring

Monitor your MAP Trade running on a Moto G51 (or any Android/Termux device) from a laptop or desktop on the same local network.
