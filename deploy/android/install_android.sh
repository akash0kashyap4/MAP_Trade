...
# ============================================
# MAP TRADE BOT — ANDROID/TERMUX INSTALLATION
# ============================================
...
echo "=== MAP TRADE Bot — Android/Termux Installer ==="
echo ""
...
#!/data/data/com.termux/files/usr/bin/bash
# Auto-start MAP TRADE Bot after phone reboot (requires Termux:Boot app)
